...
I’m interested in *quantitative research* that enables us to understand the properties of *complex systems* including *soft-materials* and *finance* using the principle of physics. Here, I share the research projects pertianing to *Machine Learning* and *Statistical Physics* its application in *finance*, *complex systems* and *quantitative image-processing*. 
